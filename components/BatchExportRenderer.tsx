...
import { getLayoutFilename } from '../utils/layoutUtils';
            ...
            try {
                ...
                if (exportRef.current) {
                    ...
                    if (blob) {
                        ...
                        const cleanTitle = (card.title || "carte").replace(/[^a-z0-9]/gi, '_').toLowerCase();
                        const filename = `${String(currentIndex + 1).padStart(3, '0')}_${cleanTitle}.png`;
